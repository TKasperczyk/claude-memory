...
const PROMOTION_MAX_TOKENS = 3000
const PROMOTION_BATCH_SIZE = 12
const CLAUDE_MD_MAX_CHARS = 40000
const SKILL_CONTEXT_MAX_CHARS = 60000
const SKILL_FILE_MAX_CHARS = 12000
